...
mat = scipy.io.loadmat('data/source/airplanes_anno/annotation_0001.mat')
...
for file in glob.glob('data/source/airplanes_anno/*.mat'):
    ...
    f.writerow([image_name, mat['box_coord'][0][0], mat['box_coord'][0][1], mat['box_coord'][0][2], mat['box_coord'][0][3]])
